<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="Aircondition8.aspx.cs" Inherits="AirConditioners_Aircondition8" %>
...
<br />
    ...
    <br />
    <br />
    <table border="1" style="z-index: 101; left: 46px; width: 911px; position: absolute;
        top: 230px; height: 286px">
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Air Conditioners>>Chennai" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 135px; position: absolute; top: 8px"
                                Text="Chennai Rental Showrooms , " Width="214px"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 380px; position: absolute; top: 12px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 138px; position: absolute; top: 56px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 1px; position: absolute;
                                top: 2px" Width="120px" Height="91px" ImageUrl="~/images/Chennai rentals.jpg" />

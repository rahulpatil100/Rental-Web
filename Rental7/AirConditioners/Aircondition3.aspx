<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="Aircondition3.aspx.cs" Inherits="AirConditioners_Aircondition3" %>
...
<br />
    ...
    <br />
    <br />
    <table border="1" style="z-index: 101; left: 54px; width: 911px; position: absolute;
        top: 247px; height: 286px">
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Air Conditioners>>Delhi" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 125px; position: absolute; top: 10px"
                                Text="Delhi Rental Showrooms , " Width="214px"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 394px; position: absolute; top: 10px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 124px; position: absolute; top: 50px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 1px; position: absolute;
                                top: 0px" Width="110px" Height="97px" ImageUrl="~/images/delhi rental showrm.jpg" />

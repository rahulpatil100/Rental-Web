...
public partial class AddProduct : System.Web.UI.Page
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        String cmd = "insert into Vendor(VendorName,ProductName,Category,Price,image) values('" + txtVendorName.Text + "','" + txtProductName.Text + "','" + txtCategory.Text + "','" + txtPrice.Text + "','"+s+"')";

...
public partial class book : System.Web.UI.Page
{
    ...
    protected void btnbooknow_Click(object sender, EventArgs e)
    {
        ...
        String cmd = "insert into book3 (ID,Uname,Email,Phone,PName,Day,Pices,Amount,City,Delivery,Address,ProductId,Dob) values('"  +txtID.Text+"','"+ txtUname.Text + "','" + txtEmail.Text + "','" + txtphone.Text + "','" +ddlPName.Text +"','"+ddlDay.Text +"','"+ ddlnumber.Text + "','"+ddlAmount.Text+"','"+ ddlCity.Text +"','" +txtDelivery.Text + "','" + txtAddress.Text + "','" + txtProductId.Text + "','" + txtDob.Text + "')";

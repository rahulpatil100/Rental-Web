<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="Homeappli6.aspx.cs" Inherits="HomeAppliances_Homeappli6" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <br />
    ...
    <br />
    <br />
    <table border="1" style="z-index: 101; left: 44px; width: 911px; position: absolute;
        ...
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Home Appliances>>Kolkata" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 129px; position: absolute; top: 9px"
                            ...
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 366px; position: absolute; top: 10px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 127px; position: absolute; top: 64px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 2px; position: absolute;
                                top: 5px" Width="120px" Height="87px" ImageUrl="~/images/kolkata rentals.JPG" />

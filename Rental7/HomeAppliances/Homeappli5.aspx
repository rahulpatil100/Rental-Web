<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="Homeappli5.aspx.cs" Inherits="HomeAppliances_Homeappli5" %>
...
<br />
    ...
    <br />
    <br />
    <table border="1" style="z-index: 101; left: 57px; width: 911px; position: absolute;
        top: 231px; height: 286px">
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Home Appliances>>Ahemadabad" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 140px; position: absolute; top: 12px"
                                Text="Ahemadabad Rental Showrooms , " Width="251px"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 416px; position: absolute; top: 16px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 141px; position: absolute; top: 58px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 0px; position: absolute;
                                top: 4px" Width="132px" Height="91px" ImageUrl="~/images/ahmedabad rentals.JPG" />
                            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Italic="False"
                                Font-Size="Small" ForeColor="Red" NavigateUrl="HomeAppliances.aspx" Style="z-index: 105;

...
public partial class book : System.Web.UI.Page
{
    ...
    protected void btnbooknow_Click(object sender, EventArgs e)
    {
        ...
        String cmd = "insert into book1 (ID,Uname,Email,Phone,PName,Pices,Amount,City,Delivery,Address,ProductId,Dob) values('"  +txtID.Text+"','"+ txtUname.Text + "','" + txtEmail.Text + "','" + txtphone.Text + "','" +ddlPName.Text +"','"+ ddlnumber.Text + "','"+ddlAmount.Text +"','"+ ddlCity.Text +"','" +txtDelivery.Text + "','" + txtAddress.Text + "','" + txtProductId.Text + "','" + txtDob.Text + "')";

<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="book1.aspx.cs" Inherits="book" %>
...
<td>
    ...
    <asp:DropDownList ID="ddlPName" runat="server">
        ...
        <asp:ListItem>Desktop Computer</asp:ListItem>
        <asp:ListItem>Touch Screen Pc</asp:ListItem>

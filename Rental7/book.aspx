<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="book.aspx.cs" Inherits="book" %>
...
<td>
    ...
    <asp:DropDownList ID="ddlPName" runat="server">
        <asp:ListItem>Split AC</asp:ListItem>
        <asp:ListItem>WindowsAc</asp:ListItem>
        <asp:ListItem>SplitAirConditoner</asp:ListItem>
        <asp:ListItem>WindowAirConditoner</asp:ListItem>

<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMasterPage.master" AutoEventWireup="true" CodeFile="AdminLogin.aspx.cs" Inherits="AdminLogin" %>
...
&nbsp;<table style="height: 372px; width: 414px">
    <tr>
        <td style="font-family: Arial, Helvetica, sans-serif; color: blue;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnLogin" runat="server" Font-Bold="True" Height="24px" 
                Text="Login" Width="138px" onclick="btnLogin_Click" />
            <br />
            <br />
&nbsp; ForgotPassword ?&nbsp;&nbsp;&nbsp;&nbsp;
